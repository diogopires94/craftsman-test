namespace ArticlesManager.IntegrationTests;
...
public class TestFixture
{
    ...
    public async Task RunBeforeAnyTests()
    {
        ...
        services.AddMassTransitInMemoryTestHarness(cfg =>
        {
            cfg.AddMassTransitTestHarness(harness => 
            {
                ...
                harness.AddConsumer<ArticlesOrderStockConsumer>();

                harness.AddConsumer<ArticlesSyncConsumer>();

                harness.AddConsumer<ArticlesStockUpdatesConsumer>();

                harness.AddConsumer<ArticlesStocksConsumer>();
            });
        });
    ...
    private static TestcontainerDatabase dbSetup()
    {
        return new TestcontainersBuilder<PostgreSqlTestcontainer>()
            ...
            .WithName($"IntegrationTesting_ArticlesManager_{Guid.NewGuid()}")
