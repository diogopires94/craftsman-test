...
public class GetUserChartTests : TestBase
{
    [Test]
    public async Task get_userchart_returns_success_when_entity_exists()
    {
        // Arrange
        ...
        // Act
        var route = ApiRoutes.UserCharts.GetRecord.Replace(ApiRoutes.UserCharts.Id, fakeUserChart.Id.ToString());
