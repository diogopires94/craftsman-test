...
public class SizeTableForManipulationDtoValidator<T> : AbstractValidator<T> where T : SizeTableForManipulationDto
{
    public SizeTableForManipulationDtoValidator()
    {
