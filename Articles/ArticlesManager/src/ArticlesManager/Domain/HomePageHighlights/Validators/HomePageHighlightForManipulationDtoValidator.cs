...
public class HomePageHighlightForManipulationDtoValidator<T> : AbstractValidator<T> where T : HomePageHighlightForManipulationDto
{
    public HomePageHighlightForManipulationDtoValidator()
    {
