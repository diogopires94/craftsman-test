...
public class UserChartForManipulationDtoValidator<T> : AbstractValidator<T> where T : UserChartForManipulationDto
{
    public UserChartForManipulationDtoValidator()
    {
