...
public class ArticlePromotionForManipulationDtoValidator<T> : AbstractValidator<T> where T : ArticlePromotionForManipulationDto
{
    public ArticlePromotionForManipulationDtoValidator()
    {
