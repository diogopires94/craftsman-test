...
public class ArticleImageForManipulationDtoValidator<T> : AbstractValidator<T> where T : ArticleImageForManipulationDto
{
    public ArticleImageForManipulationDtoValidator()
    {
