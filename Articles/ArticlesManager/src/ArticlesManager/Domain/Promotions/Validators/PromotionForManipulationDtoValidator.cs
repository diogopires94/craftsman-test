...
public class PromotionForManipulationDtoValidator<T> : AbstractValidator<T> where T : PromotionForManipulationDto
{
    public PromotionForManipulationDtoValidator()
    {
