...
public class CollectionForManipulationDtoValidator<T> : AbstractValidator<T> where T : CollectionForManipulationDto
{
    public CollectionForManipulationDtoValidator()
    {
