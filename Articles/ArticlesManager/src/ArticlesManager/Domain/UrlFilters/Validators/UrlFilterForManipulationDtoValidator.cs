...
public class UrlFilterForManipulationDtoValidator<T> : AbstractValidator<T> where T : UrlFilterForManipulationDto
{
    public UrlFilterForManipulationDtoValidator()
    {
