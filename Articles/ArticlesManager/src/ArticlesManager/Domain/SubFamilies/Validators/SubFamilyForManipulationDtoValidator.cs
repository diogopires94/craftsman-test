...
public class SubFamilyForManipulationDtoValidator<T> : AbstractValidator<T> where T : SubFamilyForManipulationDto
{
    public SubFamilyForManipulationDtoValidator()
    {
