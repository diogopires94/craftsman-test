...
public class SizeTableLineForManipulationDtoValidator<T> : AbstractValidator<T> where T : SizeTableLineForManipulationDto
{
    public SizeTableLineForManipulationDtoValidator()
    {
