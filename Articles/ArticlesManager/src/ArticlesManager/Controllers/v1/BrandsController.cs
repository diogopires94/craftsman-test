...
public class BrandsController: ControllerBase
{
    ...
    public BrandsController(IMediator mediator, IHeimGuardClient heimGuard)
    {
    ...
    public async Task<ActionResult<BrandDto>> AddBrand([FromBody]BrandForCreationDto brandForCreation)
    {
        var command = new AddBrand.AddBrandCommand(brandForCreation);
        var commandResponse = await _mediator.Send(command);

        return CreatedAtRoute("GetBrand",
    ...
    {
        var query = new GetBrand.BrandQuery(id);
    ...
    public async Task<IActionResult> GetBrands([FromQuery] BrandParametersDto brandParametersDto)
    {
        var query = new GetBrandList.BrandListQuery(brandParametersDto);
        var queryResponse = await _mediator.Send(query);
    ...
    public async Task<IActionResult> UpdateBrand(Guid id, BrandForUpdateDto brand)
    {
        var command = new UpdateBrand.UpdateBrandCommand(id, brand);
