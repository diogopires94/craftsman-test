...
[ApiController]
[Route("api/urls-products")]
[ApiVersion("1.0")]
public class UrlsWithProductsController: ControllerBase
{
    private readonly IMediator _mediator;

    public UrlsWithProductsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    [HttpGet(Name = "UrlsWithProducts")]
    public async Task<IActionResult> UrlsWithProducts([FromQuery] UrlsWithProductsParametersDto urlParametersDto)
    {
        var query = new GetUrlsWithProductsList.UrlsWithProductsListQuery(urlParametersDto);
