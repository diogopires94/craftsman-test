...
public class FamiliesController: ControllerBase
{
    ...
    public FamiliesController(IMediator mediator, IHeimGuardClient heimGuard)
    {
    ...
    public async Task<IActionResult> GetFamilies([FromQuery] FamilyParametersDto familyParametersDto)
    {
    ...
    [ProducesResponseType(500)]
    [Produces("application/json")]
    [HttpPut("{id:guid}", Name = "UpdateFamily")]
    ...
    [ProducesResponseType(500)]
    [Produces("application/json")]
    [HttpDelete("{id:guid}", Name = "DeleteFamily")]
