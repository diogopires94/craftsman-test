namespace ArticlesManager.Databases.EntityConfigurations;

using ArticlesManager.Domain.HomePageHighlights;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public class HomePageHighlightConfiguration : IEntityTypeConfiguration<HomePageHighlight>
{
    /// <summary>
    /// The database configuration for HomePageHighlights. 
    /// </summary>
    public void Configure(EntityTypeBuilder<HomePageHighlight> builder)
    {
