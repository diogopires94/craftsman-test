...
public static class ArticlesSyncEndpointRegistration
{
    public static void ArticlesSyncEndpoint(this IRabbitMqBusFactoryConfigurator cfg, IBusRegistrationContext context)
    {
        cfg.ReceiveEndpoint("articles-sync", re =>
        {
            ...
            re.ConfigureConsumer<ArticlesSyncConsumer>(context);

            // the binding of the intermediary exchange and the primary exchange
            re.Bind("maxiretail-articles-requests", e =>
            {
